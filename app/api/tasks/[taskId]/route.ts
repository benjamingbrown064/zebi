  ...
  try {
    ...
    return NextResponse.json({
      ...
      task: {
        ...
        skillId: (task as any).skillId || undefined,
        skipEvaluation: (task as any).skipEvaluation || undefined,
        skipEvaluationReason: (task as any).skipEvaluationReason || undefined,
