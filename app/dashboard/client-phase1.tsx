...
export default function DashboardClient({
  ...
  // AI suggestions count (mock for now - will connect to actual AI later)
  const aiSuggestionsCount = 4
          ...
          <div className="max-w-[1280px] mx-auto px-12 py-8">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-[13px] text-[#A3A3A3] mt-1">Your command centre for today</p>
              </div>
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="px-4 py-2 rounded-md border border-[#E5E5E5] text-[13px] font-medium text-[#525252] hover:bg-[#F5F5F5] transition-colors flex items-center gap-2"
                >
...
function TodaysPlanCard({
  ...
  return (
    <div className="bg-white rounded border border-[#E5E5E5] p-8">
      {/* Header */}
      ...
      {aiSuggestionsCount > 0 && (
        <button
          ...
          className="w-full mb-6 p-4 bg-[#F5F5F5] hover:bg-[#E5E5E5] border border-[#E5E5E5] rounded transition-colors text-left"
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="space-y-2 mt-2">
                {additionalTasks.map(task => (
                  <div
                    key={task.id}
                    onClick={() => onTaskClick(task.id)}
                    className="p-2.5 bg-white border border-[#E5E5E5] rounded-md cursor-pointer hover:bg-[#F5F5F5] transition-colors"
                  >
...
function ObjectivesCard({
  ...
  return (
    <div className="bg-white rounded border border-[#E5E5E5] p-6">
      {/* Header */}
        ...
        <div className="space-y-3">
          {displayObjectives.map(obj => (
            <div
              ...
              className="p-4 border border-[#E5E5E5] rounded cursor-pointer hover:shadow-[0_2px_8px_rgba(0,0,0,0.06)] transition-shadow"
            >
              {/* Space */}
              {obj.spaceName && (
...
// AI Suggestions Modal Content (mock for now)
function SuggestionsModalContent() {
  // TODO: Connect to actual AI prioritization engine
  const mockSuggestions = [
    {
      id: '1',
      title: 'Review dealer warranty claim from Redline',
      reason: 'Overdue by 3 days, blocking objective revenue target',
      type: 'task',
      priority: 'high'
    },
    {
      id: '2',
      title: 'Update DGS documentation',
      reason: 'Revenue-linked (DGS), 90% complete',
      type: 'project',
      priority: 'medium'
    },
    {
      id: '3',
      title: 'Complete Taskbox GTM strategy',
      reason: 'Primary goal deadline in 5 days',
      type: 'objective',
      priority: 'high'
    },
    {
      ...
      reason: 'Quick win, closes out admin tasks',
      type: 'task',
      priority: 'low'
    },
  ]
  ...
  return (
    <div className="space-y-4">
      ...
      {mockSuggestions.map((item, index) => (
        <div key={item.id} className="p-4 bg-[#F5F5F5] rounded">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-[13px] text-[#737373]">{item.reason}</p>
              <div className="flex gap-2 mt-3">
                <button className="text-[12px] px-3 py-1.5 bg-white hover:bg-[#E5E5E5] border border-[#E5E5E5] rounded-md transition-colors">
                  Add to Primary
                </button>
                <button className="text-[12px] px-3 py-1.5 bg-white hover:bg-[#E5E5E5] border border-[#E5E5E5] rounded-md transition-colors">
                  Add to Secondary
