...
export default function ProgressBreakdown({
  ...
  return (
    <div className="bg-white rounded-[14px] border border-[#E5E5E5] p-6">
      ...
      {scopeChangeNote && (
        <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-[10px] flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-blue-700">{scopeChangeNote}</p>
          </div>
        </div>
      )}
        ...
        <>
          ...
          {expanded && (
            <div className="mt-3 pt-3 border-t border-[#E5E5E5] space-y-2">
              ...
              <div className="mt-3 p-2 bg-[#FAFAFA] rounded-[6px]">
                <p className="text-xs text-[#525252]">
