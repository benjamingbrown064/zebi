    ...
    >
      <div className="flex items-start justify-between">
        <div className="flex-1">
          ...
          <p className="font-medium text-[#1A1C1C] mt-1">{title}</p>
          <p className="text-xs text-[#474747] mt-1">{description}</p>
        </div>
        ...
        <button
          ...
          className="ml-2 text-[#C4C0C0] hover:text-[#474747] transition flex-shrink-0"
          title="Dismiss"
        >
          ✕
        </button>
